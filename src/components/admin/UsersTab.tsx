...
export const UsersTab = () => {
  ...
  return (
    <>
      <div className="text-sm text-muted-foreground mb-4">共 {total} 位用户</div>
        ...
        <Table>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={5} className="text-center py-12 text-muted-foreground">暂无用户</TableCell>
              </TableRow>
            ) : (
              users.map((u) => (
                <TableRow key={u.id}>
                  ...
                  <TableCell className="text-right">
                    <Button size="sm" variant="outline" onClick={() => openAdjustDialog(u)}>调整积分</Button>
                  </TableCell>
                </TableRow>
              ))
            )}
