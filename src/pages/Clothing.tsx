            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
              {section.tools.map((tool, index) => (
                <button
                  ...
                  className="glass-card min-h-[150px] p-4 md:p-5 rounded-[20px] md:rounded-2xl hover:shadow-lg transition-shadow duration-200 group relative overflow-hidden text-left active:scale-[0.98] opacity-0 animate-fade-in"
                ...
                >
                  ...
                  <h4 className="font-semibold text-foreground mb-1.5 md:mb-2 text-sm md:text-base leading-tight">{tool.title}</h4>
                  <p className="text-[11px] md:text-xs font-medium text-primary/85 mb-1">功能介绍</p>
                  <p className="text-xs md:text-sm text-muted-foreground leading-relaxed line-clamp-3 md:line-clamp-2">
                    {tool.description}
                  </p>
                </button>
              ))}
