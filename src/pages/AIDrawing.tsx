...
const contentFrameworks = [
  ...
  },
  {
    ...
    name: "漫画故事",
    icon: "📖",
    prompt: "Create a COLORFUL, warm, hand-drawn comic strip with rich scene-based storytelling.\n\n【STYLE】\n- Warm hand-drawn illustration, full color, soft warm palette (cream background, warm browns, oranges, yellows)\n- Colored pencil and marker texture, hand-illustrated feel\n- Cute characters with big expressive eyes, round faces, varied poses and lively emotions\n- Like a premium illustrated knowledge comic or storytelling card\n\n【LAYOUT】\n- 6 comic panels in 3 rows × 2 columns, panel sizes can vary for emphasis\n- Bold main title banner at top\n- Each panel has a short colored sub-topic header\n\n【SCENE STORYTELLING】\n- Each panel shows a real scene with characters actively doing things in a setting (shops, offices, homes, streets, etc.)\n- Characters interact with each other and objects: talking, pointing, working, shopping, celebrating\n- 3-6 characters per panel with different appearances and expressions\n- Rich environmental props: furniture, tools, products, buildings, signs\n- Speech bubbles, thought bubbles, question marks, exclamation marks\n- Text labels woven into scenes naturally (on signs, labels, speech bubbles)\n- Use visual storytelling to explain concepts through character actions\n\n【QUALITY】\n1. Full color with warm tones throughout\n2. Friendly, cute illustration style\n3. Clean readable text\n4. Consistent characters across panels\n5. Lively, warm, story-driven, visually rich\n\nUser request: {user_prompt}"
  },
  {
    id: "flowchart",
    name: "流程图",
