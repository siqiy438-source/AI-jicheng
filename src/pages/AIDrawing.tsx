...
const contentFrameworks = [
  ...
  },
  {
    ...
    name: "漫画故事",
    icon: "📖",
    prompt: "Create a COLORFUL, warm, hand-drawn comic strip with RICH SCENE-BASED storytelling.\n\n【STYLE】\n- Warm hand-drawn illustration style, FULL COLOR (NOT black and white, NOT manga)\n- Soft warm palette: cream/beige background, warm browns, oranges, yellows, muted reds\n- Colored pencil / marker hand-drawn texture - must look hand-illustrated, NOT like clip-art or PowerPoint\n- Characters: cute with big expressive eyes, round faces, MANY varied poses and lively emotions\n- Style reference: like a premium hand-drawn knowledge comic or illustrated storytelling card\n\n【COMPOSITION - CRITICAL】\n- 6 comic panels arranged in a 3-row × 2-column layout\n- Panel sizes can VARY - some panels can be larger to emphasize key points (asymmetric layout is encouraged)\n- Bold main title banner at the very top with large eye-catching text\n- Each panel has a short colored sub-topic header/label\n\n【SCENE-BASED STORYTELLING - MOST IMPORTANT】\n- Each panel must depict a REAL SCENE with characters ACTIVELY DOING things in a setting (NOT abstract icons or diagrams)\n- Show characters in real environments: shops, offices, streets, homes, classrooms, kitchens, etc.\n- Characters should INTERACT with each other and with objects: talking, pointing, carrying things, working, shopping, arguing, celebrating\n- Use MANY characters per panel (3-6 people) with different appearances, outfits, and expressions\n- Include rich environmental props: furniture, tools, products, buildings, vehicles, food, plants, signs\n- Add speech bubbles with short dialogue, thought bubbles, question marks, exclamation marks\n- Use visual storytelling to explain concepts: show cause-and-effect through character actions, not through abstract charts\n- Annotations and text labels should be woven INTO the scene naturally (on signs, labels, speech bubbles), not floating as separate diagram elements\n\n【AVOID THESE MISTAKES】\n- Do NOT create infographic/diagram/table layouts - this is a COMIC, not a PowerPoint\n- Do NOT use abstract icons (clouds, recycling arrows, generic symbols) as main visual elements\n- Do NOT make rigid symmetric grid layouts - vary the composition\n- Do NOT leave panels empty or sparse - each panel should be full of life and detail\n- Do NOT make characters static or stiff - they should be dynamic and expressive\n\n【TECHNICAL】\n1. MUST be full color with warm tones - absolutely NO black and white\n2. NOT Japanese manga style - warmer, friendlier, cuter illustration style\n3. Text must be clean and readable\n4. Consistent character design across all panels\n5. Overall feeling: lively, warm, story-driven, visually rich hand-drawn comic\n\nUser request: {user_prompt}"
  },
  {
    id: "flowchart",
    name: "流程图",
