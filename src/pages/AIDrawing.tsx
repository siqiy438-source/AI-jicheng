...
const contentFrameworks = [
  ...
  },
  {
    ...
    name: "漫画故事",
    icon: "📖",
    prompt: "Create an INFORMATION-RICH, colorful comic-style infographic illustration with HIGH VISUAL DENSITY.\n\n【STYLE】\n- Warm hand-drawn illustration style, FULL COLOR (NOT black and white, NOT manga)\n- Soft warm palette: cream/beige background, warm browns, oranges, yellows, muted reds\n- Colored pencil / marker texture, like a professional illustrated explainer\n- Characters: cute chibi-like with big expressive eyes, round faces, varied poses and emotions\n- Each panel must be DENSELY packed with illustrations, text labels, and visual elements\n\n【COMPOSITION - CRITICAL】\n- 6 comic panels in a 3-row × 2-column grid layout (this is MANDATORY)\n- Bold main title banner at the very top with large eye-catching text\n- Each panel MUST have: a colored sub-topic header/label bar (dark or colored background with contrasting text), PLUS rich illustrations below it\n- Every panel should contain MULTIPLE visual elements: 3-5 characters or objects, text annotations, arrows, icons, speech bubbles\n- Use creative VISUAL METAPHORS to explain abstract concepts (e.g., weights/chains for burdens, balloons for lightness, rockets for growth, scales for comparison, magnifying glass for analysis)\n- Add small annotation labels, callout boxes, and explanatory text scattered throughout each panel\n- Vary character actions and expressions across panels - show people working, thinking, celebrating, struggling\n- Include props and scene details relevant to the topic in every panel\n\n【INFORMATION DENSITY - VERY IMPORTANT】\n1. Do NOT leave empty space - fill each panel with meaningful visual content\n2. Each panel should convey a distinct sub-point with BOTH illustrations AND text working together\n3. Use icons, symbols, and small diagrams alongside character illustrations\n4. Add comparison visuals, simple charts, or process arrows where relevant\n5. Include speech bubbles, thought bubbles, and exclamation effects\n6. Small decorative elements: stars, sparkles, emphasis lines, emoji-like icons\n\n【TECHNICAL】\n1. MUST be full color with warm tones - absolutely NO black and white\n2. NOT Japanese manga style - warmer, friendlier illustration style\n3. Text must be clean, readable, and abundant - labels on everything\n4. Consistent character design across all 6 panels\n5. Overall: information-rich, visually engaging, like a premium illustrated knowledge card\n\nUser request: {user_prompt}"
  },
  {
    id: "flowchart",
    name: "流程图",
