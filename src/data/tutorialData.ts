...
export const tutorials: ToolTutorial[] = [
  ...
  },
  {
    ...
    route: "/ai-hangoutfit",
    summary: "上传内搭与单品，自动补全完整挂搭效果图。",
    tutorialImage: "/tutorials/ai-hangoutfit.webp",
    steps: [
      { stepNumber: 1, title: "上传三件单品", description: "分别在三个上传区域上传内搭、上衣、裤子的图片，系统会自动补充包包和配饰。" },
      { stepNumber: 2, title: "选择画质", description: "选择输出画质：标准、2K 或 4K。画质越高，生成时间越长但效果更精细。" },
      { stepNumber: 3, title: "生成挂搭图", description: "点击生成，AI 将三件单品组合为完整的挂搭展示效果图，自动添加搭配的包包和配饰。" },
