...
export const FASHION_MODEL_MIRROR_SELFIE_PROMPT = `生成一张高真实度“对镜自拍”穿搭照片，风格接近日常博主手机实拍。

【镜前自拍构图 - 必须严格遵守】
- 全身镜自拍视角，模特正对镜子站立，画面是镜中反射
- 竖版构图，必须完整展示从头到脚，不可裁掉鞋子或头顶
- 背景为简洁室内环境（浅色墙面 + 木地板），干净自然，不要杂乱陈设
- 整体像生活化穿搭记录，不要棚拍感

【遮脸与手机规则 - 强制】
- 模特必须手持手机自拍，手机位于脸前
- 手机型号固定为 iPhone 13 Pro（三摄方形镜头模组）
- 手机必须遮挡完整脸部核心区域，眼睛、鼻子、嘴巴不得清晰可见
- 严禁出现清晰五官，禁止露脸

【穿搭要求 - 强制完整】
- 模特必须完整穿着上传的所有服装单品
- 画面必须体现：外套/上衣 + 内搭 + 裤子/裙子，三者缺一不可
- 服装颜色、版型、材质尽量还原上传图，不随意改款
- 服装有自然褶皱与垂坠，避免塑料感与过度磨皮

【氛围与细节】
- 姿态自然放松，可微微偏重心或轻度交叉腿，像真实镜前随手拍
- 光线为自然室内光，柔和阴影，真实手机拍摄质感
- 可少量加入通勤配饰（包、项链、帽子），但不要抢主体

【禁止出现】
- 露脸、手机未挡脸、非 iPhone 13 Pro、半身裁切
- 手指畸形、身体比例异常、服装缺失、低清晰度、明显AI伪影
- 文字水印、UI元素、拼贴排版
