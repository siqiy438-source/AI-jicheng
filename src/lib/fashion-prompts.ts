...
export const FASHION_MODEL_FACELESS_FULL_PROMPT = `生成一张时尚穿搭博主风格的全身无脸照片，展示完整的穿搭比例和上下身搭配关系。

【裁切与构图 — 最关键，必须严格遵守】
- 画面上边界：裁切到鼻子以下，嘴巴和下巴可见，但眼睛和鼻子绝对不能出现
- 画面下边界：到脚面，鞋子必须完整可见
- 模特从头顶裁切处到脚尖填满画面 85-90% 的垂直空间
- 竖版 9:16 比例

【模特姿态】
- 中国女性，身材匀称，比例优越
- 身体朝向：10°-30° 的微侧转，比半身图更接近正面，但仍然不是完全正对镜头
- 站姿自然放松，重心微偏一侧，一条腿略微放松，形成自然的体态
- 肩膀放松，整体呈现"随意站着"的松弛感
- 皮肤质感真实自然
...
全身图的手部动作比半身图更随意自然：
- 一只手自然垂放在身侧
- 另一只手可以：轻搭在包带上、插在裤兜里（半插）、自然握住包的提手
- 手指放松自然，不要僵硬
- 整体感觉是"站在那里等朋友"的日常状态

【穿搭展示 — 完整比例是核心】
- 模特必须完整穿着用户上传的所有服装单品
- 全身可见，从肩膀到鞋子，展示完整的穿搭比例关系
- 上下身的比例搭配要协调（如：宽松上衣 + 修身下装，或 oversized 外套 + 直筒裤）
- 叠穿层次清晰，每层衣服边界分明
- 衣服的颜色、款式、面料质感必须与上传图片高度一致
- 根据服装风格智能搭配：
  - 一双合适的鞋子（与整体风格协调：切尔西靴、乐福鞋、尖头鞋、小白鞋等）
  - 一个包袋（斜挎包、手提包或肩背包）
  - 可选：1 件小配饰（耳饰、围巾等）
...
【背景】
- 白色或浅灰色墙面
- 地面：浅色木地板（人字拼或直铺）或浅灰色地面
- 干净整洁，无杂物、无道具
- 无文字、无水印

【禁止出现】
眼睛、鼻子、完整面部、变形的手指、过度磨皮、AI 塑料感、鲜艳颜色、杂乱背景、僵硬的模特站姿、不自然的身体比例

风格参考：小红书穿搭博主全身无脸 OOTD、Instagram fashion blogger faceless outfit post
