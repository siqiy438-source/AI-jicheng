...
export const FEATURE_PRICES: Record<string, FeaturePriceConfig> = {
  ...
  ai_image_hd: { name: '高清绘图(2K/4K)', cost: 100, billing: 'fixed' },
  ...
  ai_display_hd: { name: '陈列图(2K/4K)', cost: 100, billing: 'fixed' },
  ai_outfit_standard: { name: '挂搭图(标准)', cost: 50, billing: 'fixed' },
  ai_outfit_premium: { name: '挂搭图(Pro)', cost: 100, billing: 'fixed' },
  ai_outfit_hd: { name: '挂搭图(2K/4K)', cost: 100, billing: 'fixed' },
  ai_fashion_standard: { name: '模特图(标准)', cost: 50, billing: 'fixed' },
  ai_fashion_premium: { name: '模特图(Pro)', cost: 100, billing: 'fixed' },
  ai_fashion_hd: { name: '模特图(2K/4K)', cost: 100, billing: 'fixed' },
  ai_fashion_breakdown_standard: { name: '穿搭拆解图(标准)', cost: 50, billing: 'fixed' },
  ai_fashion_breakdown_premium: { name: '穿搭拆解图(Pro)', cost: 100, billing: 'fixed' },
  ai_fashion_breakdown_hd: { name: '穿搭拆解图(2K/4K)', cost: 100, billing: 'fixed' },
  ...
  ai_virtual_tryon_hd: { name: '定点换衣(2K/4K)', cost: 100, billing: 'fixed' },
  ai_detail_standard: { name: '细节特写(标准)', cost: 50, billing: 'fixed' },
  ai_detail_premium: { name: '细节特写(Pro)', cost: 100, billing: 'fixed' },
  ai_detail_hd: { name: '细节特写(2K/4K)', cost: 100, billing: 'fixed' },
  ai_flatlay_standard: { name: '平铺摆拍(标准)', cost: 50, billing: 'fixed' },
  ai_flatlay_premium: { name: '平铺摆拍(Pro)', cost: 100, billing: 'fixed' },
  ai_flatlay_hd: { name: '平铺摆拍(2K/4K)', cost: 100, billing: 'fixed' },
  ai_copywriting: { name: '朋友圈文案', cost: 10, billing: 'fixed' },
  ai_ppt_outline: { name: 'PPT大纲', cost: 10, billing: 'fixed' },
